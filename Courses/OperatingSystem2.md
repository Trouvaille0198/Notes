...
- **多级索引组织**：一级索引块存储二级索引盘块号，小容量文件浪费存储空间
    ...
    <img src="C:\Users\Tyeah\AppData\Roaming\Typora\typora-user-images\image-20211227092147002.png" alt="image-20211227092147002" style="zoom:40%;" />
...
- 位示图法：使用 1bit 标识盘块使用情况，本质是一个二维数组
