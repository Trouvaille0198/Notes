...
设$R$为非空集合$A$上的偏序关系，$\forall x,y\in A$，若$x\preceq y\land y\preceq x$，则称$x$与$y$**可比**

#### 2）拟序

设$R$为非空集合$A$上的偏序关系，若$R$是反自反的和传递的，则称$R$是$A$上的**拟序关系**，简称为拟序，记作$\prec$

![image-20210114163511534](https://trou.oss-cn-shanghai.aliyuncs.com/img/image-20210114163511534.png)
...
![image-20210302154139091](http://image.trouvaille0198.top/image-20210302154139091.png)